      ...
      studio: z
        .object({
          ...
          labels: z.object({
            ...
            reportKicker: z.string(),
            reportRaisedTitle: z.string(),
            reportBoughtTitle: z.string(),
            reportBought1: z.string(),
            reportBought2: z.string(),
            reportBought3: z.string(),
            reportBought4: z.string(),
            reportSourceTitle: z.string(),
            reportSource1: z.string(),
            reportSource2: z.string(),
            reportSource3: z.string(),
            reportDelivered: z.string(),
            reportThanks: z.string(),
            reportThanksBody: z.string(),
          }),
        })
        .strict(),
    })
